...
import (
	...
	functionsCluster "github.com/oracle/provider-oci/apis/cluster/functions/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	functionsNamespaced "github.com/oracle/provider-oci/apis/namespaced/functions/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(functionsCluster.AddToScheme(mgr.GetScheme()), "Cannot add functions Cluster APIs to scheme")
	kingpin.FatalIfError(functionsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add functions Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_functions(mgr, ClusterOpts), "Cannot setup functions Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_functions(mgr, NamespacedOpts), "Cannot setup functions Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_functions(mgr, ClusterOpts), "Cannot setup functions Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_functions(mgr, NamespacedOpts), "Cannot setup functions Template controllers")
	}
