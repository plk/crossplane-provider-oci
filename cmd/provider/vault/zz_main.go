...
import (
	...
	vaultCluster "github.com/oracle/provider-oci/apis/cluster/vault/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	vaultNamespaced "github.com/oracle/provider-oci/apis/namespaced/vault/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(vaultCluster.AddToScheme(mgr.GetScheme()), "Cannot add vault Cluster APIs to scheme")
	kingpin.FatalIfError(vaultNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add vault Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_vault(mgr, ClusterOpts), "Cannot setup vault Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_vault(mgr, NamespacedOpts), "Cannot setup vault Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_vault(mgr, ClusterOpts), "Cannot setup vault Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_vault(mgr, NamespacedOpts), "Cannot setup vault Template controllers")
	}
