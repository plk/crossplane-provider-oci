...
import (
	...
	demandsignalCluster "github.com/oracle/provider-oci/apis/cluster/demandsignal/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	demandsignalNamespaced "github.com/oracle/provider-oci/apis/namespaced/demandsignal/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(demandsignalCluster.AddToScheme(mgr.GetScheme()), "Cannot add demandsignal Cluster APIs to scheme")
	kingpin.FatalIfError(demandsignalNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add demandsignal Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_demandsignal(mgr, ClusterOpts), "Cannot setup demandsignal Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_demandsignal(mgr, NamespacedOpts), "Cannot setup demandsignal Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_demandsignal(mgr, ClusterOpts), "Cannot setup demandsignal Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_demandsignal(mgr, NamespacedOpts), "Cannot setup demandsignal Template controllers")
	}
