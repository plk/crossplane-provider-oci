...
import (
	...
	loganalyticsCluster "github.com/oracle/provider-oci/apis/cluster/loganalytics/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	loganalyticsNamespaced "github.com/oracle/provider-oci/apis/namespaced/loganalytics/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(loganalyticsCluster.AddToScheme(mgr.GetScheme()), "Cannot add loganalytics Cluster APIs to scheme")
	kingpin.FatalIfError(loganalyticsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add loganalytics Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_loganalytics(mgr, ClusterOpts), "Cannot setup loganalytics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_loganalytics(mgr, NamespacedOpts), "Cannot setup loganalytics Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_loganalytics(mgr, ClusterOpts), "Cannot setup loganalytics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_loganalytics(mgr, NamespacedOpts), "Cannot setup loganalytics Template controllers")
	}
