...
import (
	...
	apmCluster "github.com/oracle/provider-oci/apis/cluster/apm/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	apmNamespaced "github.com/oracle/provider-oci/apis/namespaced/apm/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(apmCluster.AddToScheme(mgr.GetScheme()), "Cannot add apm Cluster APIs to scheme")
	kingpin.FatalIfError(apmNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add apm Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_apm(mgr, ClusterOpts), "Cannot setup apm Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_apm(mgr, NamespacedOpts), "Cannot setup apm Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_apm(mgr, ClusterOpts), "Cannot setup apm Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_apm(mgr, NamespacedOpts), "Cannot setup apm Template controllers")
	}
