...
import (
	...
	difCluster "github.com/oracle/provider-oci/apis/cluster/dif/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	difNamespaced "github.com/oracle/provider-oci/apis/namespaced/dif/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(difCluster.AddToScheme(mgr.GetScheme()), "Cannot add dif Cluster APIs to scheme")
	kingpin.FatalIfError(difNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add dif Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_dif(mgr, ClusterOpts), "Cannot setup dif Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_dif(mgr, NamespacedOpts), "Cannot setup dif Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_dif(mgr, ClusterOpts), "Cannot setup dif Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_dif(mgr, NamespacedOpts), "Cannot setup dif Template controllers")
	}
