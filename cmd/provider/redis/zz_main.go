...
import (
	...
	redisCluster "github.com/oracle/provider-oci/apis/cluster/redis/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	redisNamespaced "github.com/oracle/provider-oci/apis/namespaced/redis/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(redisCluster.AddToScheme(mgr.GetScheme()), "Cannot add redis Cluster APIs to scheme")
	kingpin.FatalIfError(redisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add redis Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_redis(mgr, ClusterOpts), "Cannot setup redis Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_redis(mgr, NamespacedOpts), "Cannot setup redis Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_redis(mgr, ClusterOpts), "Cannot setup redis Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_redis(mgr, NamespacedOpts), "Cannot setup redis Template controllers")
	}
