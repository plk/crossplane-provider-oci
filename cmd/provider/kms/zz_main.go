...
import (
	...
	kmsCluster "github.com/oracle/provider-oci/apis/cluster/kms/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	kmsNamespaced "github.com/oracle/provider-oci/apis/namespaced/kms/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(kmsCluster.AddToScheme(mgr.GetScheme()), "Cannot add kms Cluster APIs to scheme")
	kingpin.FatalIfError(kmsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add kms Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_kms(mgr, ClusterOpts), "Cannot setup kms Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_kms(mgr, NamespacedOpts), "Cannot setup kms Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_kms(mgr, ClusterOpts), "Cannot setup kms Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_kms(mgr, NamespacedOpts), "Cannot setup kms Template controllers")
	}
