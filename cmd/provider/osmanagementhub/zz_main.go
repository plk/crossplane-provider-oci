...
import (
	...
	osmanagementhubCluster "github.com/oracle/provider-oci/apis/cluster/osmanagementhub/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	osmanagementhubNamespaced "github.com/oracle/provider-oci/apis/namespaced/osmanagementhub/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(osmanagementhubCluster.AddToScheme(mgr.GetScheme()), "Cannot add osmanagementhub Cluster APIs to scheme")
	kingpin.FatalIfError(osmanagementhubNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add osmanagementhub Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_osmanagementhub(mgr, ClusterOpts), "Cannot setup osmanagementhub Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_osmanagementhub(mgr, NamespacedOpts), "Cannot setup osmanagementhub Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_osmanagementhub(mgr, ClusterOpts), "Cannot setup osmanagementhub Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_osmanagementhub(mgr, NamespacedOpts), "Cannot setup osmanagementhub Template controllers")
	}
