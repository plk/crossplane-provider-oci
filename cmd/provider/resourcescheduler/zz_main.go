...
import (
	...
	resourceschedulerCluster "github.com/oracle/provider-oci/apis/cluster/resourcescheduler/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	resourceschedulerNamespaced "github.com/oracle/provider-oci/apis/namespaced/resourcescheduler/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(resourceschedulerCluster.AddToScheme(mgr.GetScheme()), "Cannot add resourcescheduler Cluster APIs to scheme")
	kingpin.FatalIfError(resourceschedulerNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add resourcescheduler Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_resourcescheduler(mgr, ClusterOpts), "Cannot setup resourcescheduler Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_resourcescheduler(mgr, NamespacedOpts), "Cannot setup resourcescheduler Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_resourcescheduler(mgr, ClusterOpts), "Cannot setup resourcescheduler Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_resourcescheduler(mgr, NamespacedOpts), "Cannot setup resourcescheduler Template controllers")
	}
