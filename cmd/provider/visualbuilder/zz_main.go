...
import (
	...
	visualbuilderCluster "github.com/oracle/provider-oci/apis/cluster/visualbuilder/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	visualbuilderNamespaced "github.com/oracle/provider-oci/apis/namespaced/visualbuilder/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(visualbuilderCluster.AddToScheme(mgr.GetScheme()), "Cannot add visualbuilder Cluster APIs to scheme")
	kingpin.FatalIfError(visualbuilderNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add visualbuilder Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_visualbuilder(mgr, ClusterOpts), "Cannot setup visualbuilder Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_visualbuilder(mgr, NamespacedOpts), "Cannot setup visualbuilder Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_visualbuilder(mgr, ClusterOpts), "Cannot setup visualbuilder Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_visualbuilder(mgr, NamespacedOpts), "Cannot setup visualbuilder Template controllers")
	}
