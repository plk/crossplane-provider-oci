...
import (
	...
	bdsCluster "github.com/oracle/provider-oci/apis/cluster/bds/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	bdsNamespaced "github.com/oracle/provider-oci/apis/namespaced/bds/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(bdsCluster.AddToScheme(mgr.GetScheme()), "Cannot add bds Cluster APIs to scheme")
	kingpin.FatalIfError(bdsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add bds Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_bds(mgr, ClusterOpts), "Cannot setup bds Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_bds(mgr, NamespacedOpts), "Cannot setup bds Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_bds(mgr, ClusterOpts), "Cannot setup bds Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_bds(mgr, NamespacedOpts), "Cannot setup bds Template controllers")
	}
