...
import (
	...
	datalabelingserviceCluster "github.com/oracle/provider-oci/apis/cluster/datalabelingservice/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	datalabelingserviceNamespaced "github.com/oracle/provider-oci/apis/namespaced/datalabelingservice/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(datalabelingserviceCluster.AddToScheme(mgr.GetScheme()), "Cannot add datalabelingservice Cluster APIs to scheme")
	kingpin.FatalIfError(datalabelingserviceNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add datalabelingservice Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_datalabelingservice(mgr, ClusterOpts), "Cannot setup datalabelingservice Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_datalabelingservice(mgr, NamespacedOpts), "Cannot setup datalabelingservice Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_datalabelingservice(mgr, ClusterOpts), "Cannot setup datalabelingservice Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_datalabelingservice(mgr, NamespacedOpts), "Cannot setup datalabelingservice Template controllers")
	}
