...
import (
	...
	desktopsCluster "github.com/oracle/provider-oci/apis/cluster/desktops/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	desktopsNamespaced "github.com/oracle/provider-oci/apis/namespaced/desktops/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(desktopsCluster.AddToScheme(mgr.GetScheme()), "Cannot add desktops Cluster APIs to scheme")
	kingpin.FatalIfError(desktopsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add desktops Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_desktops(mgr, ClusterOpts), "Cannot setup desktops Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_desktops(mgr, NamespacedOpts), "Cannot setup desktops Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_desktops(mgr, ClusterOpts), "Cannot setup desktops Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_desktops(mgr, NamespacedOpts), "Cannot setup desktops Template controllers")
	}
