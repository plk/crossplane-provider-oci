...
import (
	...
	capacitymanagementCluster "github.com/oracle/provider-oci/apis/cluster/capacitymanagement/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	capacitymanagementNamespaced "github.com/oracle/provider-oci/apis/namespaced/capacitymanagement/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(capacitymanagementCluster.AddToScheme(mgr.GetScheme()), "Cannot add capacitymanagement Cluster APIs to scheme")
	kingpin.FatalIfError(capacitymanagementNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add capacitymanagement Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_capacitymanagement(mgr, ClusterOpts), "Cannot setup capacitymanagement Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_capacitymanagement(mgr, NamespacedOpts), "Cannot setup capacitymanagement Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_capacitymanagement(mgr, ClusterOpts), "Cannot setup capacitymanagement Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_capacitymanagement(mgr, NamespacedOpts), "Cannot setup capacitymanagement Template controllers")
	}
