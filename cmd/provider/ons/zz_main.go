...
import (
	...
	onsCluster "github.com/oracle/provider-oci/apis/cluster/ons/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	onsNamespaced "github.com/oracle/provider-oci/apis/namespaced/ons/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(onsCluster.AddToScheme(mgr.GetScheme()), "Cannot add ons Cluster APIs to scheme")
	kingpin.FatalIfError(onsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add ons Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_ons(mgr, ClusterOpts), "Cannot setup ons Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_ons(mgr, NamespacedOpts), "Cannot setup ons Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_ons(mgr, ClusterOpts), "Cannot setup ons Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_ons(mgr, NamespacedOpts), "Cannot setup ons Template controllers")
	}
