...
import (
	...
	wafCluster "github.com/oracle/provider-oci/apis/cluster/waf/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	wafNamespaced "github.com/oracle/provider-oci/apis/namespaced/waf/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(wafCluster.AddToScheme(mgr.GetScheme()), "Cannot add waf Cluster APIs to scheme")
	kingpin.FatalIfError(wafNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add waf Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_waf(mgr, ClusterOpts), "Cannot setup waf Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_waf(mgr, NamespacedOpts), "Cannot setup waf Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_waf(mgr, ClusterOpts), "Cannot setup waf Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_waf(mgr, NamespacedOpts), "Cannot setup waf Template controllers")
	}
