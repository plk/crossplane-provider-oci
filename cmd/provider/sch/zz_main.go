...
import (
	...
	schCluster "github.com/oracle/provider-oci/apis/cluster/sch/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	schNamespaced "github.com/oracle/provider-oci/apis/namespaced/sch/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(schCluster.AddToScheme(mgr.GetScheme()), "Cannot add sch Cluster APIs to scheme")
	kingpin.FatalIfError(schNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add sch Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_sch(mgr, ClusterOpts), "Cannot setup sch Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_sch(mgr, NamespacedOpts), "Cannot setup sch Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_sch(mgr, ClusterOpts), "Cannot setup sch Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_sch(mgr, NamespacedOpts), "Cannot setup sch Template controllers")
	}
