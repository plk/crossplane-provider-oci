...
import (
	...
	databaseCluster "github.com/oracle/provider-oci/apis/cluster/database/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	databaseNamespaced "github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(databaseCluster.AddToScheme(mgr.GetScheme()), "Cannot add database Cluster APIs to scheme")
	kingpin.FatalIfError(databaseNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add database Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_database(mgr, ClusterOpts), "Cannot setup database Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_database(mgr, NamespacedOpts), "Cannot setup database Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_database(mgr, ClusterOpts), "Cannot setup database Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_database(mgr, NamespacedOpts), "Cannot setup database Template controllers")
	}
