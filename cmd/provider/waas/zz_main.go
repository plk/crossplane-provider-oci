...
import (
	...
	waasCluster "github.com/oracle/provider-oci/apis/cluster/waas/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	waasNamespaced "github.com/oracle/provider-oci/apis/namespaced/waas/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(waasCluster.AddToScheme(mgr.GetScheme()), "Cannot add waas Cluster APIs to scheme")
	kingpin.FatalIfError(waasNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add waas Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_waas(mgr, ClusterOpts), "Cannot setup waas Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_waas(mgr, NamespacedOpts), "Cannot setup waas Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_waas(mgr, ClusterOpts), "Cannot setup waas Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_waas(mgr, NamespacedOpts), "Cannot setup waas Template controllers")
	}
