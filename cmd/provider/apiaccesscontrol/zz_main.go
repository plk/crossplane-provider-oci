...
import (
	...
	apiaccesscontrolCluster "github.com/oracle/provider-oci/apis/cluster/apiaccesscontrol/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	apiaccesscontrolNamespaced "github.com/oracle/provider-oci/apis/namespaced/apiaccesscontrol/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(apiaccesscontrolCluster.AddToScheme(mgr.GetScheme()), "Cannot add apiaccesscontrol Cluster APIs to scheme")
	kingpin.FatalIfError(apiaccesscontrolNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add apiaccesscontrol Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_apiaccesscontrol(mgr, ClusterOpts), "Cannot setup apiaccesscontrol Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_apiaccesscontrol(mgr, NamespacedOpts), "Cannot setup apiaccesscontrol Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_apiaccesscontrol(mgr, ClusterOpts), "Cannot setup apiaccesscontrol Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_apiaccesscontrol(mgr, NamespacedOpts), "Cannot setup apiaccesscontrol Template controllers")
	}
