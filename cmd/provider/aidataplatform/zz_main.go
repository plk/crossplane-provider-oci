...
import (
	...
	aidataplatformCluster "github.com/oracle/provider-oci/apis/cluster/aidataplatform/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	aidataplatformNamespaced "github.com/oracle/provider-oci/apis/namespaced/aidataplatform/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(aidataplatformCluster.AddToScheme(mgr.GetScheme()), "Cannot add aidataplatform Cluster APIs to scheme")
	kingpin.FatalIfError(aidataplatformNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add aidataplatform Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_aidataplatform(mgr, ClusterOpts), "Cannot setup aidataplatform Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_aidataplatform(mgr, NamespacedOpts), "Cannot setup aidataplatform Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_aidataplatform(mgr, ClusterOpts), "Cannot setup aidataplatform Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_aidataplatform(mgr, NamespacedOpts), "Cannot setup aidataplatform Template controllers")
	}
