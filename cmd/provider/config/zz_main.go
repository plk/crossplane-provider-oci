...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_config(mgr, ClusterOpts), "Cannot setup config Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_config(mgr, NamespacedOpts), "Cannot setup config Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_config(mgr, ClusterOpts), "Cannot setup config Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_config(mgr, NamespacedOpts), "Cannot setup config Template controllers")
	}
