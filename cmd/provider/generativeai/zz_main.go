...
import (
	...
	generativeaiCluster "github.com/oracle/provider-oci/apis/cluster/generativeai/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	generativeaiNamespaced "github.com/oracle/provider-oci/apis/namespaced/generativeai/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(generativeaiCluster.AddToScheme(mgr.GetScheme()), "Cannot add generativeai Cluster APIs to scheme")
	kingpin.FatalIfError(generativeaiNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add generativeai Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_generativeai(mgr, ClusterOpts), "Cannot setup generativeai Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_generativeai(mgr, NamespacedOpts), "Cannot setup generativeai Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_generativeai(mgr, ClusterOpts), "Cannot setup generativeai Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_generativeai(mgr, NamespacedOpts), "Cannot setup generativeai Template controllers")
	}
