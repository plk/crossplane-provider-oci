...
import (
	...
	datasafeCluster "github.com/oracle/provider-oci/apis/cluster/datasafe/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	datasafeNamespaced "github.com/oracle/provider-oci/apis/namespaced/datasafe/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(datasafeCluster.AddToScheme(mgr.GetScheme()), "Cannot add datasafe Cluster APIs to scheme")
	kingpin.FatalIfError(datasafeNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add datasafe Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_datasafe(mgr, ClusterOpts), "Cannot setup datasafe Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_datasafe(mgr, NamespacedOpts), "Cannot setup datasafe Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_datasafe(mgr, ClusterOpts), "Cannot setup datasafe Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_datasafe(mgr, NamespacedOpts), "Cannot setup datasafe Template controllers")
	}
