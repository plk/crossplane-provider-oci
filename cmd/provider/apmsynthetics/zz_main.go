...
import (
	...
	apmsyntheticsCluster "github.com/oracle/provider-oci/apis/cluster/apmsynthetics/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	apmsyntheticsNamespaced "github.com/oracle/provider-oci/apis/namespaced/apmsynthetics/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(apmsyntheticsCluster.AddToScheme(mgr.GetScheme()), "Cannot add apmsynthetics Cluster APIs to scheme")
	kingpin.FatalIfError(apmsyntheticsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add apmsynthetics Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_apmsynthetics(mgr, ClusterOpts), "Cannot setup apmsynthetics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_apmsynthetics(mgr, NamespacedOpts), "Cannot setup apmsynthetics Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_apmsynthetics(mgr, ClusterOpts), "Cannot setup apmsynthetics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_apmsynthetics(mgr, NamespacedOpts), "Cannot setup apmsynthetics Template controllers")
	}
