...
import (
	...
	fusionappsCluster "github.com/oracle/provider-oci/apis/cluster/fusionapps/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	fusionappsNamespaced "github.com/oracle/provider-oci/apis/namespaced/fusionapps/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(fusionappsCluster.AddToScheme(mgr.GetScheme()), "Cannot add fusionapps Cluster APIs to scheme")
	kingpin.FatalIfError(fusionappsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add fusionapps Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_fusionapps(mgr, ClusterOpts), "Cannot setup fusionapps Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_fusionapps(mgr, NamespacedOpts), "Cannot setup fusionapps Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_fusionapps(mgr, ClusterOpts), "Cannot setup fusionapps Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_fusionapps(mgr, NamespacedOpts), "Cannot setup fusionapps Template controllers")
	}
