...
import (
	...
	objectstorageCluster "github.com/oracle/provider-oci/apis/cluster/objectstorage/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	objectstorageNamespaced "github.com/oracle/provider-oci/apis/namespaced/objectstorage/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(objectstorageCluster.AddToScheme(mgr.GetScheme()), "Cannot add objectstorage Cluster APIs to scheme")
	kingpin.FatalIfError(objectstorageNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add objectstorage Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_objectstorage(mgr, ClusterOpts), "Cannot setup objectstorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_objectstorage(mgr, NamespacedOpts), "Cannot setup objectstorage Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_objectstorage(mgr, ClusterOpts), "Cannot setup objectstorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_objectstorage(mgr, NamespacedOpts), "Cannot setup objectstorage Template controllers")
	}
