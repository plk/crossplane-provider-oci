...
import (
	...
	dbmulticloudCluster "github.com/oracle/provider-oci/apis/cluster/dbmulticloud/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	dbmulticloudNamespaced "github.com/oracle/provider-oci/apis/namespaced/dbmulticloud/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(dbmulticloudCluster.AddToScheme(mgr.GetScheme()), "Cannot add dbmulticloud Cluster APIs to scheme")
	kingpin.FatalIfError(dbmulticloudNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add dbmulticloud Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_dbmulticloud(mgr, ClusterOpts), "Cannot setup dbmulticloud Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_dbmulticloud(mgr, NamespacedOpts), "Cannot setup dbmulticloud Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_dbmulticloud(mgr, ClusterOpts), "Cannot setup dbmulticloud Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_dbmulticloud(mgr, NamespacedOpts), "Cannot setup dbmulticloud Template controllers")
	}
