...
import (
	...
	resourceanalyticsCluster "github.com/oracle/provider-oci/apis/cluster/resourceanalytics/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	resourceanalyticsNamespaced "github.com/oracle/provider-oci/apis/namespaced/resourceanalytics/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(resourceanalyticsCluster.AddToScheme(mgr.GetScheme()), "Cannot add resourceanalytics Cluster APIs to scheme")
	kingpin.FatalIfError(resourceanalyticsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add resourceanalytics Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_resourceanalytics(mgr, ClusterOpts), "Cannot setup resourceanalytics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_resourceanalytics(mgr, NamespacedOpts), "Cannot setup resourceanalytics Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_resourceanalytics(mgr, ClusterOpts), "Cannot setup resourceanalytics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_resourceanalytics(mgr, NamespacedOpts), "Cannot setup resourceanalytics Template controllers")
	}
