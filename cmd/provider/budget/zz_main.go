...
import (
	...
	budgetCluster "github.com/oracle/provider-oci/apis/cluster/budget/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	budgetNamespaced "github.com/oracle/provider-oci/apis/namespaced/budget/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(budgetCluster.AddToScheme(mgr.GetScheme()), "Cannot add budget Cluster APIs to scheme")
	kingpin.FatalIfError(budgetNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add budget Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_budget(mgr, ClusterOpts), "Cannot setup budget Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_budget(mgr, NamespacedOpts), "Cannot setup budget Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_budget(mgr, ClusterOpts), "Cannot setup budget Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_budget(mgr, NamespacedOpts), "Cannot setup budget Template controllers")
	}
