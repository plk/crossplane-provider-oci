...
import (
	...
	jmsjavadownloadsCluster "github.com/oracle/provider-oci/apis/cluster/jmsjavadownloads/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	jmsjavadownloadsNamespaced "github.com/oracle/provider-oci/apis/namespaced/jmsjavadownloads/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(jmsjavadownloadsCluster.AddToScheme(mgr.GetScheme()), "Cannot add jmsjavadownloads Cluster APIs to scheme")
	kingpin.FatalIfError(jmsjavadownloadsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add jmsjavadownloads Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_jmsjavadownloads(mgr, ClusterOpts), "Cannot setup jmsjavadownloads Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_jmsjavadownloads(mgr, NamespacedOpts), "Cannot setup jmsjavadownloads Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_jmsjavadownloads(mgr, ClusterOpts), "Cannot setup jmsjavadownloads Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_jmsjavadownloads(mgr, NamespacedOpts), "Cannot setup jmsjavadownloads Template controllers")
	}
