...
import (
	...
	coreCluster "github.com/oracle/provider-oci/apis/cluster/core/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	coreNamespaced "github.com/oracle/provider-oci/apis/namespaced/core/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(coreCluster.AddToScheme(mgr.GetScheme()), "Cannot add core Cluster APIs to scheme")
	kingpin.FatalIfError(coreNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add core Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_core(mgr, ClusterOpts), "Cannot setup core Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_core(mgr, NamespacedOpts), "Cannot setup core Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_core(mgr, ClusterOpts), "Cannot setup core Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_core(mgr, NamespacedOpts), "Cannot setup core Template controllers")
	}
