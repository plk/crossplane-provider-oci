...
import (
	...
	vbsinstCluster "github.com/oracle/provider-oci/apis/cluster/vbsinst/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	vbsinstNamespaced "github.com/oracle/provider-oci/apis/namespaced/vbsinst/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(vbsinstCluster.AddToScheme(mgr.GetScheme()), "Cannot add vbsinst Cluster APIs to scheme")
	kingpin.FatalIfError(vbsinstNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add vbsinst Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_vbsinst(mgr, ClusterOpts), "Cannot setup vbsinst Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_vbsinst(mgr, NamespacedOpts), "Cannot setup vbsinst Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_vbsinst(mgr, ClusterOpts), "Cannot setup vbsinst Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_vbsinst(mgr, NamespacedOpts), "Cannot setup vbsinst Template controllers")
	}
