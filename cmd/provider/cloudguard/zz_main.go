...
import (
	...
	cloudguardCluster "github.com/oracle/provider-oci/apis/cluster/cloudguard/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	cloudguardNamespaced "github.com/oracle/provider-oci/apis/namespaced/cloudguard/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(cloudguardCluster.AddToScheme(mgr.GetScheme()), "Cannot add cloudguard Cluster APIs to scheme")
	kingpin.FatalIfError(cloudguardNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add cloudguard Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_cloudguard(mgr, ClusterOpts), "Cannot setup cloudguard Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_cloudguard(mgr, NamespacedOpts), "Cannot setup cloudguard Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_cloudguard(mgr, ClusterOpts), "Cannot setup cloudguard Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_cloudguard(mgr, NamespacedOpts), "Cannot setup cloudguard Template controllers")
	}
