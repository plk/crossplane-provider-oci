...
import (
	...
	lustrefilestorageCluster "github.com/oracle/provider-oci/apis/cluster/lustrefilestorage/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	lustrefilestorageNamespaced "github.com/oracle/provider-oci/apis/namespaced/lustrefilestorage/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(lustrefilestorageCluster.AddToScheme(mgr.GetScheme()), "Cannot add lustrefilestorage Cluster APIs to scheme")
	kingpin.FatalIfError(lustrefilestorageNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add lustrefilestorage Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_lustrefilestorage(mgr, ClusterOpts), "Cannot setup lustrefilestorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_lustrefilestorage(mgr, NamespacedOpts), "Cannot setup lustrefilestorage Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_lustrefilestorage(mgr, ClusterOpts), "Cannot setup lustrefilestorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_lustrefilestorage(mgr, NamespacedOpts), "Cannot setup lustrefilestorage Template controllers")
	}
