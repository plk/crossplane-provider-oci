...
import (
	...
	jmsutilsCluster "github.com/oracle/provider-oci/apis/cluster/jmsutils/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	jmsutilsNamespaced "github.com/oracle/provider-oci/apis/namespaced/jmsutils/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(jmsutilsCluster.AddToScheme(mgr.GetScheme()), "Cannot add jmsutils Cluster APIs to scheme")
	kingpin.FatalIfError(jmsutilsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add jmsutils Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_jmsutils(mgr, ClusterOpts), "Cannot setup jmsutils Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_jmsutils(mgr, NamespacedOpts), "Cannot setup jmsutils Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_jmsutils(mgr, ClusterOpts), "Cannot setup jmsutils Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_jmsutils(mgr, NamespacedOpts), "Cannot setup jmsutils Template controllers")
	}
