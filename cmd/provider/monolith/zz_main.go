...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_monolith(mgr, ClusterOpts), "Cannot setup monolith Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_monolith(mgr, NamespacedOpts), "Cannot setup monolith Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_monolith(mgr, ClusterOpts), "Cannot setup monolith Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_monolith(mgr, NamespacedOpts), "Cannot setup monolith Template controllers")
	}
