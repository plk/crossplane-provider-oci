...
import (
	...
	mediaservicesCluster "github.com/oracle/provider-oci/apis/cluster/mediaservices/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	mediaservicesNamespaced "github.com/oracle/provider-oci/apis/namespaced/mediaservices/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(mediaservicesCluster.AddToScheme(mgr.GetScheme()), "Cannot add mediaservices Cluster APIs to scheme")
	kingpin.FatalIfError(mediaservicesNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add mediaservices Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_mediaservices(mgr, ClusterOpts), "Cannot setup mediaservices Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_mediaservices(mgr, NamespacedOpts), "Cannot setup mediaservices Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_mediaservices(mgr, ClusterOpts), "Cannot setup mediaservices Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_mediaservices(mgr, NamespacedOpts), "Cannot setup mediaservices Template controllers")
	}
