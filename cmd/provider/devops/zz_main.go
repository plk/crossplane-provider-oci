...
import (
	...
	devopsCluster "github.com/oracle/provider-oci/apis/cluster/devops/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	devopsNamespaced "github.com/oracle/provider-oci/apis/namespaced/devops/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(devopsCluster.AddToScheme(mgr.GetScheme()), "Cannot add devops Cluster APIs to scheme")
	kingpin.FatalIfError(devopsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add devops Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_devops(mgr, ClusterOpts), "Cannot setup devops Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_devops(mgr, NamespacedOpts), "Cannot setup devops Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_devops(mgr, ClusterOpts), "Cannot setup devops Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_devops(mgr, NamespacedOpts), "Cannot setup devops Template controllers")
	}
