...
import (
	...
	apigatewayCluster "github.com/oracle/provider-oci/apis/cluster/apigateway/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	apigatewayNamespaced "github.com/oracle/provider-oci/apis/namespaced/apigateway/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(apigatewayCluster.AddToScheme(mgr.GetScheme()), "Cannot add apigateway Cluster APIs to scheme")
	kingpin.FatalIfError(apigatewayNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add apigateway Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_apigateway(mgr, ClusterOpts), "Cannot setup apigateway Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_apigateway(mgr, NamespacedOpts), "Cannot setup apigateway Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_apigateway(mgr, ClusterOpts), "Cannot setup apigateway Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_apigateway(mgr, NamespacedOpts), "Cannot setup apigateway Template controllers")
	}
