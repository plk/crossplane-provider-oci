...
import (
	...
	opsiCluster "github.com/oracle/provider-oci/apis/cluster/opsi/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	opsiNamespaced "github.com/oracle/provider-oci/apis/namespaced/opsi/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(opsiCluster.AddToScheme(mgr.GetScheme()), "Cannot add opsi Cluster APIs to scheme")
	kingpin.FatalIfError(opsiNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add opsi Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_opsi(mgr, ClusterOpts), "Cannot setup opsi Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_opsi(mgr, NamespacedOpts), "Cannot setup opsi Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_opsi(mgr, ClusterOpts), "Cannot setup opsi Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_opsi(mgr, NamespacedOpts), "Cannot setup opsi Template controllers")
	}
