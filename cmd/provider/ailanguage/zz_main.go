...
import (
	...
	ailanguageCluster "github.com/oracle/provider-oci/apis/cluster/ailanguage/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	ailanguageNamespaced "github.com/oracle/provider-oci/apis/namespaced/ailanguage/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(ailanguageCluster.AddToScheme(mgr.GetScheme()), "Cannot add ailanguage Cluster APIs to scheme")
	kingpin.FatalIfError(ailanguageNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add ailanguage Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_ailanguage(mgr, ClusterOpts), "Cannot setup ailanguage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_ailanguage(mgr, NamespacedOpts), "Cannot setup ailanguage Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_ailanguage(mgr, ClusterOpts), "Cannot setup ailanguage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_ailanguage(mgr, NamespacedOpts), "Cannot setup ailanguage Template controllers")
	}
