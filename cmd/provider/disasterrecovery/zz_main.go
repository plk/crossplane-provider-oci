...
import (
	...
	disasterrecoveryCluster "github.com/oracle/provider-oci/apis/cluster/disasterrecovery/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	disasterrecoveryNamespaced "github.com/oracle/provider-oci/apis/namespaced/disasterrecovery/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(disasterrecoveryCluster.AddToScheme(mgr.GetScheme()), "Cannot add disasterrecovery Cluster APIs to scheme")
	kingpin.FatalIfError(disasterrecoveryNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add disasterrecovery Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_disasterrecovery(mgr, ClusterOpts), "Cannot setup disasterrecovery Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_disasterrecovery(mgr, NamespacedOpts), "Cannot setup disasterrecovery Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_disasterrecovery(mgr, ClusterOpts), "Cannot setup disasterrecovery Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_disasterrecovery(mgr, NamespacedOpts), "Cannot setup disasterrecovery Template controllers")
	}
