...
import (
	...
	cloudmigrationsCluster "github.com/oracle/provider-oci/apis/cluster/cloudmigrations/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	cloudmigrationsNamespaced "github.com/oracle/provider-oci/apis/namespaced/cloudmigrations/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(cloudmigrationsCluster.AddToScheme(mgr.GetScheme()), "Cannot add cloudmigrations Cluster APIs to scheme")
	kingpin.FatalIfError(cloudmigrationsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add cloudmigrations Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_cloudmigrations(mgr, ClusterOpts), "Cannot setup cloudmigrations Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_cloudmigrations(mgr, NamespacedOpts), "Cannot setup cloudmigrations Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_cloudmigrations(mgr, ClusterOpts), "Cannot setup cloudmigrations Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_cloudmigrations(mgr, NamespacedOpts), "Cannot setup cloudmigrations Template controllers")
	}
