...
import (
	...
	blockchainCluster "github.com/oracle/provider-oci/apis/cluster/blockchain/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	blockchainNamespaced "github.com/oracle/provider-oci/apis/namespaced/blockchain/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(blockchainCluster.AddToScheme(mgr.GetScheme()), "Cannot add blockchain Cluster APIs to scheme")
	kingpin.FatalIfError(blockchainNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add blockchain Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_blockchain(mgr, ClusterOpts), "Cannot setup blockchain Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_blockchain(mgr, NamespacedOpts), "Cannot setup blockchain Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_blockchain(mgr, ClusterOpts), "Cannot setup blockchain Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_blockchain(mgr, NamespacedOpts), "Cannot setup blockchain Template controllers")
	}
