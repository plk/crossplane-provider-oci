...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_core(mgr, ClusterOpts), "Cannot setup cluster-scoped Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_core(mgr, NamespacedOpts), "Cannot setup namespaced Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_core(mgr, ClusterOpts), "Cannot setup cluster-scoped Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_core(mgr, NamespacedOpts), "Cannot setup namespaced Template controllers")
	}
