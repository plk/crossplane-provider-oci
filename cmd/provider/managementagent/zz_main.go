...
import (
	...
	managementagentCluster "github.com/oracle/provider-oci/apis/cluster/managementagent/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	managementagentNamespaced "github.com/oracle/provider-oci/apis/namespaced/managementagent/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(managementagentCluster.AddToScheme(mgr.GetScheme()), "Cannot add managementagent Cluster APIs to scheme")
	kingpin.FatalIfError(managementagentNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add managementagent Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_managementagent(mgr, ClusterOpts), "Cannot setup managementagent Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_managementagent(mgr, NamespacedOpts), "Cannot setup managementagent Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_managementagent(mgr, ClusterOpts), "Cannot setup managementagent Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_managementagent(mgr, NamespacedOpts), "Cannot setup managementagent Template controllers")
	}
