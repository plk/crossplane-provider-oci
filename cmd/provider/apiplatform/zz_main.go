...
import (
	...
	apiplatformCluster "github.com/oracle/provider-oci/apis/cluster/apiplatform/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	apiplatformNamespaced "github.com/oracle/provider-oci/apis/namespaced/apiplatform/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(apiplatformCluster.AddToScheme(mgr.GetScheme()), "Cannot add apiplatform Cluster APIs to scheme")
	kingpin.FatalIfError(apiplatformNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add apiplatform Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_apiplatform(mgr, ClusterOpts), "Cannot setup apiplatform Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_apiplatform(mgr, NamespacedOpts), "Cannot setup apiplatform Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_apiplatform(mgr, ClusterOpts), "Cannot setup apiplatform Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_apiplatform(mgr, NamespacedOpts), "Cannot setup apiplatform Template controllers")
	}
