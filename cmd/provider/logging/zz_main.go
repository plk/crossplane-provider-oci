...
import (
	...
	loggingCluster "github.com/oracle/provider-oci/apis/cluster/logging/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	loggingNamespaced "github.com/oracle/provider-oci/apis/namespaced/logging/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(loggingCluster.AddToScheme(mgr.GetScheme()), "Cannot add logging Cluster APIs to scheme")
	kingpin.FatalIfError(loggingNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add logging Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_logging(mgr, ClusterOpts), "Cannot setup logging Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_logging(mgr, NamespacedOpts), "Cannot setup logging Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_logging(mgr, ClusterOpts), "Cannot setup logging Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_logging(mgr, NamespacedOpts), "Cannot setup logging Template controllers")
	}
