...
import (
	...
	usageproxyCluster "github.com/oracle/provider-oci/apis/cluster/usageproxy/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	usageproxyNamespaced "github.com/oracle/provider-oci/apis/namespaced/usageproxy/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(usageproxyCluster.AddToScheme(mgr.GetScheme()), "Cannot add usageproxy Cluster APIs to scheme")
	kingpin.FatalIfError(usageproxyNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add usageproxy Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_usageproxy(mgr, ClusterOpts), "Cannot setup usageproxy Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_usageproxy(mgr, NamespacedOpts), "Cannot setup usageproxy Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_usageproxy(mgr, ClusterOpts), "Cannot setup usageproxy Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_usageproxy(mgr, NamespacedOpts), "Cannot setup usageproxy Template controllers")
	}
