...
import (
	...
	zprCluster "github.com/oracle/provider-oci/apis/cluster/zpr/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	zprNamespaced "github.com/oracle/provider-oci/apis/namespaced/zpr/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(zprCluster.AddToScheme(mgr.GetScheme()), "Cannot add zpr Cluster APIs to scheme")
	kingpin.FatalIfError(zprNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add zpr Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_zpr(mgr, ClusterOpts), "Cannot setup zpr Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_zpr(mgr, NamespacedOpts), "Cannot setup zpr Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_zpr(mgr, ClusterOpts), "Cannot setup zpr Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_zpr(mgr, NamespacedOpts), "Cannot setup zpr Template controllers")
	}
