...
import (
	...
	healthchecksCluster "github.com/oracle/provider-oci/apis/cluster/healthchecks/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	healthchecksNamespaced "github.com/oracle/provider-oci/apis/namespaced/healthchecks/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(healthchecksCluster.AddToScheme(mgr.GetScheme()), "Cannot add healthchecks Cluster APIs to scheme")
	kingpin.FatalIfError(healthchecksNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add healthchecks Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_healthchecks(mgr, ClusterOpts), "Cannot setup healthchecks Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_healthchecks(mgr, NamespacedOpts), "Cannot setup healthchecks Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_healthchecks(mgr, ClusterOpts), "Cannot setup healthchecks Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_healthchecks(mgr, NamespacedOpts), "Cannot setup healthchecks Template controllers")
	}
