...
import (
	...
	filestorageCluster "github.com/oracle/provider-oci/apis/cluster/filestorage/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	filestorageNamespaced "github.com/oracle/provider-oci/apis/namespaced/filestorage/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(filestorageCluster.AddToScheme(mgr.GetScheme()), "Cannot add filestorage Cluster APIs to scheme")
	kingpin.FatalIfError(filestorageNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add filestorage Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_filestorage(mgr, ClusterOpts), "Cannot setup filestorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_filestorage(mgr, NamespacedOpts), "Cannot setup filestorage Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_filestorage(mgr, ClusterOpts), "Cannot setup filestorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_filestorage(mgr, NamespacedOpts), "Cannot setup filestorage Template controllers")
	}
