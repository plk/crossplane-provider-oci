...
import (
	...
	datascienceCluster "github.com/oracle/provider-oci/apis/cluster/datascience/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	datascienceNamespaced "github.com/oracle/provider-oci/apis/namespaced/datascience/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(datascienceCluster.AddToScheme(mgr.GetScheme()), "Cannot add datascience Cluster APIs to scheme")
	kingpin.FatalIfError(datascienceNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add datascience Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_datascience(mgr, ClusterOpts), "Cannot setup datascience Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_datascience(mgr, NamespacedOpts), "Cannot setup datascience Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_datascience(mgr, ClusterOpts), "Cannot setup datascience Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_datascience(mgr, NamespacedOpts), "Cannot setup datascience Template controllers")
	}
