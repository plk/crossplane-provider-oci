...
import (
	...
	aidocumentCluster "github.com/oracle/provider-oci/apis/cluster/aidocument/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	aidocumentNamespaced "github.com/oracle/provider-oci/apis/namespaced/aidocument/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(aidocumentCluster.AddToScheme(mgr.GetScheme()), "Cannot add aidocument Cluster APIs to scheme")
	kingpin.FatalIfError(aidocumentNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add aidocument Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_aidocument(mgr, ClusterOpts), "Cannot setup aidocument Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_aidocument(mgr, NamespacedOpts), "Cannot setup aidocument Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_aidocument(mgr, ClusterOpts), "Cannot setup aidocument Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_aidocument(mgr, NamespacedOpts), "Cannot setup aidocument Template controllers")
	}
