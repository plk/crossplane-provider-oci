...
import (
	...
	psaCluster "github.com/oracle/provider-oci/apis/cluster/psa/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	psaNamespaced "github.com/oracle/provider-oci/apis/namespaced/psa/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(psaCluster.AddToScheme(mgr.GetScheme()), "Cannot add psa Cluster APIs to scheme")
	kingpin.FatalIfError(psaNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add psa Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_psa(mgr, ClusterOpts), "Cannot setup psa Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_psa(mgr, NamespacedOpts), "Cannot setup psa Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_psa(mgr, ClusterOpts), "Cannot setup psa Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_psa(mgr, NamespacedOpts), "Cannot setup psa Template controllers")
	}
