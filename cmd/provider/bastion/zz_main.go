...
import (
	...
	bastionCluster "github.com/oracle/provider-oci/apis/cluster/bastion/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	bastionNamespaced "github.com/oracle/provider-oci/apis/namespaced/bastion/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(bastionCluster.AddToScheme(mgr.GetScheme()), "Cannot add bastion Cluster APIs to scheme")
	kingpin.FatalIfError(bastionNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add bastion Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_bastion(mgr, ClusterOpts), "Cannot setup bastion Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_bastion(mgr, NamespacedOpts), "Cannot setup bastion Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_bastion(mgr, ClusterOpts), "Cannot setup bastion Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_bastion(mgr, NamespacedOpts), "Cannot setup bastion Template controllers")
	}
