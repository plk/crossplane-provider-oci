...
import (
	...
	auditCluster "github.com/oracle/provider-oci/apis/cluster/audit/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	auditNamespaced "github.com/oracle/provider-oci/apis/namespaced/audit/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(auditCluster.AddToScheme(mgr.GetScheme()), "Cannot add audit Cluster APIs to scheme")
	kingpin.FatalIfError(auditNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add audit Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_audit(mgr, ClusterOpts), "Cannot setup audit Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_audit(mgr, NamespacedOpts), "Cannot setup audit Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_audit(mgr, ClusterOpts), "Cannot setup audit Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_audit(mgr, NamespacedOpts), "Cannot setup audit Template controllers")
	}
