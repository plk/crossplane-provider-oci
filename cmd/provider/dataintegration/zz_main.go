...
import (
	...
	dataintegrationCluster "github.com/oracle/provider-oci/apis/cluster/dataintegration/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	dataintegrationNamespaced "github.com/oracle/provider-oci/apis/namespaced/dataintegration/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(dataintegrationCluster.AddToScheme(mgr.GetScheme()), "Cannot add dataintegration Cluster APIs to scheme")
	kingpin.FatalIfError(dataintegrationNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add dataintegration Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_dataintegration(mgr, ClusterOpts), "Cannot setup dataintegration Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_dataintegration(mgr, NamespacedOpts), "Cannot setup dataintegration Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_dataintegration(mgr, ClusterOpts), "Cannot setup dataintegration Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_dataintegration(mgr, NamespacedOpts), "Cannot setup dataintegration Template controllers")
	}
