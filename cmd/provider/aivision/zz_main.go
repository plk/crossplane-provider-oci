...
import (
	...
	aivisionCluster "github.com/oracle/provider-oci/apis/cluster/aivision/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	aivisionNamespaced "github.com/oracle/provider-oci/apis/namespaced/aivision/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(aivisionCluster.AddToScheme(mgr.GetScheme()), "Cannot add aivision Cluster APIs to scheme")
	kingpin.FatalIfError(aivisionNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add aivision Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_aivision(mgr, ClusterOpts), "Cannot setup aivision Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_aivision(mgr, NamespacedOpts), "Cannot setup aivision Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_aivision(mgr, ClusterOpts), "Cannot setup aivision Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_aivision(mgr, NamespacedOpts), "Cannot setup aivision Template controllers")
	}
