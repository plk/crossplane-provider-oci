...
import (
	...
	ospgatewayCluster "github.com/oracle/provider-oci/apis/cluster/ospgateway/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	ospgatewayNamespaced "github.com/oracle/provider-oci/apis/namespaced/ospgateway/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(ospgatewayCluster.AddToScheme(mgr.GetScheme()), "Cannot add ospgateway Cluster APIs to scheme")
	kingpin.FatalIfError(ospgatewayNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add ospgateway Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_ospgateway(mgr, ClusterOpts), "Cannot setup ospgateway Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_ospgateway(mgr, NamespacedOpts), "Cannot setup ospgateway Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_ospgateway(mgr, ClusterOpts), "Cannot setup ospgateway Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_ospgateway(mgr, NamespacedOpts), "Cannot setup ospgateway Template controllers")
	}
