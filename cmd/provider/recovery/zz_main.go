...
import (
	...
	recoveryCluster "github.com/oracle/provider-oci/apis/cluster/recovery/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	recoveryNamespaced "github.com/oracle/provider-oci/apis/namespaced/recovery/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(recoveryCluster.AddToScheme(mgr.GetScheme()), "Cannot add recovery Cluster APIs to scheme")
	kingpin.FatalIfError(recoveryNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add recovery Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_recovery(mgr, ClusterOpts), "Cannot setup recovery Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_recovery(mgr, NamespacedOpts), "Cannot setup recovery Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_recovery(mgr, ClusterOpts), "Cannot setup recovery Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_recovery(mgr, NamespacedOpts), "Cannot setup recovery Template controllers")
	}
