...
import (
	...
	identityCluster "github.com/oracle/provider-oci/apis/cluster/identity/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	identityNamespaced "github.com/oracle/provider-oci/apis/namespaced/identity/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(identityCluster.AddToScheme(mgr.GetScheme()), "Cannot add identity Cluster APIs to scheme")
	kingpin.FatalIfError(identityNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add identity Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_identity(mgr, ClusterOpts), "Cannot setup identity Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_identity(mgr, NamespacedOpts), "Cannot setup identity Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_identity(mgr, ClusterOpts), "Cannot setup identity Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_identity(mgr, NamespacedOpts), "Cannot setup identity Template controllers")
	}
