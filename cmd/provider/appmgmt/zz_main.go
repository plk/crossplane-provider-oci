...
import (
	...
	appmgmtCluster "github.com/oracle/provider-oci/apis/cluster/appmgmt/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	appmgmtNamespaced "github.com/oracle/provider-oci/apis/namespaced/appmgmt/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(appmgmtCluster.AddToScheme(mgr.GetScheme()), "Cannot add appmgmt Cluster APIs to scheme")
	kingpin.FatalIfError(appmgmtNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add appmgmt Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_appmgmt(mgr, ClusterOpts), "Cannot setup appmgmt Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_appmgmt(mgr, NamespacedOpts), "Cannot setup appmgmt Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_appmgmt(mgr, ClusterOpts), "Cannot setup appmgmt Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_appmgmt(mgr, NamespacedOpts), "Cannot setup appmgmt Template controllers")
	}
