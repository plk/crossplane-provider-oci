...
import (
	...
	ocvpCluster "github.com/oracle/provider-oci/apis/cluster/ocvp/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	ocvpNamespaced "github.com/oracle/provider-oci/apis/namespaced/ocvp/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(ocvpCluster.AddToScheme(mgr.GetScheme()), "Cannot add ocvp Cluster APIs to scheme")
	kingpin.FatalIfError(ocvpNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add ocvp Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_ocvp(mgr, ClusterOpts), "Cannot setup ocvp Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_ocvp(mgr, NamespacedOpts), "Cannot setup ocvp Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_ocvp(mgr, ClusterOpts), "Cannot setup ocvp Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_ocvp(mgr, NamespacedOpts), "Cannot setup ocvp Template controllers")
	}
