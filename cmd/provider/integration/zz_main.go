...
import (
	...
	integrationCluster "github.com/oracle/provider-oci/apis/cluster/integration/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	integrationNamespaced "github.com/oracle/provider-oci/apis/namespaced/integration/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(integrationCluster.AddToScheme(mgr.GetScheme()), "Cannot add integration Cluster APIs to scheme")
	kingpin.FatalIfError(integrationNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add integration Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_integration(mgr, ClusterOpts), "Cannot setup integration Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_integration(mgr, NamespacedOpts), "Cannot setup integration Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_integration(mgr, ClusterOpts), "Cannot setup integration Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_integration(mgr, NamespacedOpts), "Cannot setup integration Template controllers")
	}
