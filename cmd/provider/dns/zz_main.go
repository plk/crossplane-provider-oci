...
import (
	...
	dnsCluster "github.com/oracle/provider-oci/apis/cluster/dns/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	dnsNamespaced "github.com/oracle/provider-oci/apis/namespaced/dns/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(dnsCluster.AddToScheme(mgr.GetScheme()), "Cannot add dns Cluster APIs to scheme")
	kingpin.FatalIfError(dnsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add dns Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_dns(mgr, ClusterOpts), "Cannot setup dns Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_dns(mgr, NamespacedOpts), "Cannot setup dns Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_dns(mgr, ClusterOpts), "Cannot setup dns Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_dns(mgr, NamespacedOpts), "Cannot setup dns Template controllers")
	}
