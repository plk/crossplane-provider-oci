...
import (
	...
	cloudbridgeCluster "github.com/oracle/provider-oci/apis/cluster/cloudbridge/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	cloudbridgeNamespaced "github.com/oracle/provider-oci/apis/namespaced/cloudbridge/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(cloudbridgeCluster.AddToScheme(mgr.GetScheme()), "Cannot add cloudbridge Cluster APIs to scheme")
	kingpin.FatalIfError(cloudbridgeNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add cloudbridge Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_cloudbridge(mgr, ClusterOpts), "Cannot setup cloudbridge Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_cloudbridge(mgr, NamespacedOpts), "Cannot setup cloudbridge Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_cloudbridge(mgr, ClusterOpts), "Cannot setup cloudbridge Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_cloudbridge(mgr, NamespacedOpts), "Cannot setup cloudbridge Template controllers")
	}
