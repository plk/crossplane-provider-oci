...
import (
	...
	fleetappsmanagementCluster "github.com/oracle/provider-oci/apis/cluster/fleetappsmanagement/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	fleetappsmanagementNamespaced "github.com/oracle/provider-oci/apis/namespaced/fleetappsmanagement/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(fleetappsmanagementCluster.AddToScheme(mgr.GetScheme()), "Cannot add fleetappsmanagement Cluster APIs to scheme")
	kingpin.FatalIfError(fleetappsmanagementNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add fleetappsmanagement Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_fleetappsmanagement(mgr, ClusterOpts), "Cannot setup fleetappsmanagement Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_fleetappsmanagement(mgr, NamespacedOpts), "Cannot setup fleetappsmanagement Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_fleetappsmanagement(mgr, ClusterOpts), "Cannot setup fleetappsmanagement Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_fleetappsmanagement(mgr, NamespacedOpts), "Cannot setup fleetappsmanagement Template controllers")
	}
