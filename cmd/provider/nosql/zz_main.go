...
import (
	...
	nosqlCluster "github.com/oracle/provider-oci/apis/cluster/nosql/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	nosqlNamespaced "github.com/oracle/provider-oci/apis/namespaced/nosql/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(nosqlCluster.AddToScheme(mgr.GetScheme()), "Cannot add nosql Cluster APIs to scheme")
	kingpin.FatalIfError(nosqlNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add nosql Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_nosql(mgr, ClusterOpts), "Cannot setup nosql Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_nosql(mgr, NamespacedOpts), "Cannot setup nosql Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_nosql(mgr, ClusterOpts), "Cannot setup nosql Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_nosql(mgr, NamespacedOpts), "Cannot setup nosql Template controllers")
	}
