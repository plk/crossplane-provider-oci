...
import (
	...
	dataflowCluster "github.com/oracle/provider-oci/apis/cluster/dataflow/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	dataflowNamespaced "github.com/oracle/provider-oci/apis/namespaced/dataflow/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(dataflowCluster.AddToScheme(mgr.GetScheme()), "Cannot add dataflow Cluster APIs to scheme")
	kingpin.FatalIfError(dataflowNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add dataflow Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_dataflow(mgr, ClusterOpts), "Cannot setup dataflow Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_dataflow(mgr, NamespacedOpts), "Cannot setup dataflow Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_dataflow(mgr, ClusterOpts), "Cannot setup dataflow Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_dataflow(mgr, NamespacedOpts), "Cannot setup dataflow Template controllers")
	}
