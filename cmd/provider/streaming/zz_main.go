...
import (
	...
	streamingCluster "github.com/oracle/provider-oci/apis/cluster/streaming/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	streamingNamespaced "github.com/oracle/provider-oci/apis/namespaced/streaming/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(streamingCluster.AddToScheme(mgr.GetScheme()), "Cannot add streaming Cluster APIs to scheme")
	kingpin.FatalIfError(streamingNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add streaming Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_streaming(mgr, ClusterOpts), "Cannot setup streaming Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_streaming(mgr, NamespacedOpts), "Cannot setup streaming Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_streaming(mgr, ClusterOpts), "Cannot setup streaming Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_streaming(mgr, NamespacedOpts), "Cannot setup streaming Template controllers")
	}
