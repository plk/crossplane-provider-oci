...
import (
	...
	monitoringCluster "github.com/oracle/provider-oci/apis/cluster/monitoring/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	monitoringNamespaced "github.com/oracle/provider-oci/apis/namespaced/monitoring/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(monitoringCluster.AddToScheme(mgr.GetScheme()), "Cannot add monitoring Cluster APIs to scheme")
	kingpin.FatalIfError(monitoringNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add monitoring Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_monitoring(mgr, ClusterOpts), "Cannot setup monitoring Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_monitoring(mgr, NamespacedOpts), "Cannot setup monitoring Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_monitoring(mgr, ClusterOpts), "Cannot setup monitoring Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_monitoring(mgr, NamespacedOpts), "Cannot setup monitoring Template controllers")
	}
