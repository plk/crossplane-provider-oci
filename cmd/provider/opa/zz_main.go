...
import (
	...
	opaCluster "github.com/oracle/provider-oci/apis/cluster/opa/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	opaNamespaced "github.com/oracle/provider-oci/apis/namespaced/opa/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(opaCluster.AddToScheme(mgr.GetScheme()), "Cannot add opa Cluster APIs to scheme")
	kingpin.FatalIfError(opaNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add opa Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_opa(mgr, ClusterOpts), "Cannot setup opa Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_opa(mgr, NamespacedOpts), "Cannot setup opa Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_opa(mgr, ClusterOpts), "Cannot setup opa Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_opa(mgr, NamespacedOpts), "Cannot setup opa Template controllers")
	}
