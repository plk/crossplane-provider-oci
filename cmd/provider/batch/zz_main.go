...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_batch(mgr, ClusterOpts), "Cannot setup batch Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_batch(mgr, NamespacedOpts), "Cannot setup batch Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_batch(mgr, ClusterOpts), "Cannot setup batch Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_batch(mgr, NamespacedOpts), "Cannot setup batch Template controllers")
	}
