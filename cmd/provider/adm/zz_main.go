...
import (
	...
	admCluster "github.com/oracle/provider-oci/apis/cluster/adm/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	admNamespaced "github.com/oracle/provider-oci/apis/namespaced/adm/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(admCluster.AddToScheme(mgr.GetScheme()), "Cannot add adm Cluster APIs to scheme")
	kingpin.FatalIfError(admNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add adm Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_adm(mgr, ClusterOpts), "Cannot setup adm Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_adm(mgr, NamespacedOpts), "Cannot setup adm Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_adm(mgr, ClusterOpts), "Cannot setup adm Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_adm(mgr, NamespacedOpts), "Cannot setup adm Template controllers")
	}
