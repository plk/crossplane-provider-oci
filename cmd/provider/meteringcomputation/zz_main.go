...
import (
	...
	meteringcomputationCluster "github.com/oracle/provider-oci/apis/cluster/meteringcomputation/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	meteringcomputationNamespaced "github.com/oracle/provider-oci/apis/namespaced/meteringcomputation/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(meteringcomputationCluster.AddToScheme(mgr.GetScheme()), "Cannot add meteringcomputation Cluster APIs to scheme")
	kingpin.FatalIfError(meteringcomputationNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add meteringcomputation Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_meteringcomputation(mgr, ClusterOpts), "Cannot setup meteringcomputation Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_meteringcomputation(mgr, NamespacedOpts), "Cannot setup meteringcomputation Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_meteringcomputation(mgr, ClusterOpts), "Cannot setup meteringcomputation Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_meteringcomputation(mgr, NamespacedOpts), "Cannot setup meteringcomputation Template controllers")
	}
