...
import (
	...
	iotCluster "github.com/oracle/provider-oci/apis/cluster/iot/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	iotNamespaced "github.com/oracle/provider-oci/apis/namespaced/iot/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(iotCluster.AddToScheme(mgr.GetScheme()), "Cannot add iot Cluster APIs to scheme")
	kingpin.FatalIfError(iotNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add iot Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_iot(mgr, ClusterOpts), "Cannot setup iot Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_iot(mgr, NamespacedOpts), "Cannot setup iot Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_iot(mgr, ClusterOpts), "Cannot setup iot Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_iot(mgr, NamespacedOpts), "Cannot setup iot Template controllers")
	}
