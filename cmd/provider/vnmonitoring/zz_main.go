...
import (
	...
	vnmonitoringCluster "github.com/oracle/provider-oci/apis/cluster/vnmonitoring/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	vnmonitoringNamespaced "github.com/oracle/provider-oci/apis/namespaced/vnmonitoring/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(vnmonitoringCluster.AddToScheme(mgr.GetScheme()), "Cannot add vnmonitoring Cluster APIs to scheme")
	kingpin.FatalIfError(vnmonitoringNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add vnmonitoring Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_vnmonitoring(mgr, ClusterOpts), "Cannot setup vnmonitoring Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_vnmonitoring(mgr, NamespacedOpts), "Cannot setup vnmonitoring Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_vnmonitoring(mgr, ClusterOpts), "Cannot setup vnmonitoring Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_vnmonitoring(mgr, NamespacedOpts), "Cannot setup vnmonitoring Template controllers")
	}
