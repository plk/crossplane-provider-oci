...
import (
	...
	apmtracesCluster "github.com/oracle/provider-oci/apis/cluster/apmtraces/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	apmtracesNamespaced "github.com/oracle/provider-oci/apis/namespaced/apmtraces/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(apmtracesCluster.AddToScheme(mgr.GetScheme()), "Cannot add apmtraces Cluster APIs to scheme")
	kingpin.FatalIfError(apmtracesNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add apmtraces Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_apmtraces(mgr, ClusterOpts), "Cannot setup apmtraces Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_apmtraces(mgr, NamespacedOpts), "Cannot setup apmtraces Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_apmtraces(mgr, ClusterOpts), "Cannot setup apmtraces Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_apmtraces(mgr, NamespacedOpts), "Cannot setup apmtraces Template controllers")
	}
