...
import (
	...
	autoscalingCluster "github.com/oracle/provider-oci/apis/cluster/autoscaling/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	autoscalingNamespaced "github.com/oracle/provider-oci/apis/namespaced/autoscaling/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(autoscalingCluster.AddToScheme(mgr.GetScheme()), "Cannot add autoscaling Cluster APIs to scheme")
	kingpin.FatalIfError(autoscalingNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add autoscaling Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_autoscaling(mgr, ClusterOpts), "Cannot setup autoscaling Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_autoscaling(mgr, NamespacedOpts), "Cannot setup autoscaling Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_autoscaling(mgr, ClusterOpts), "Cannot setup autoscaling Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_autoscaling(mgr, NamespacedOpts), "Cannot setup autoscaling Template controllers")
	}
