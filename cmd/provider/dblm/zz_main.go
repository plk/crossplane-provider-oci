...
import (
	...
	dblmCluster "github.com/oracle/provider-oci/apis/cluster/dblm/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	dblmNamespaced "github.com/oracle/provider-oci/apis/namespaced/dblm/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(dblmCluster.AddToScheme(mgr.GetScheme()), "Cannot add dblm Cluster APIs to scheme")
	kingpin.FatalIfError(dblmNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add dblm Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_dblm(mgr, ClusterOpts), "Cannot setup dblm Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_dblm(mgr, NamespacedOpts), "Cannot setup dblm Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_dblm(mgr, ClusterOpts), "Cannot setup dblm Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_dblm(mgr, NamespacedOpts), "Cannot setup dblm Template controllers")
	}
