...
import (
	...
	managedkafkaCluster "github.com/oracle/provider-oci/apis/cluster/managedkafka/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	managedkafkaNamespaced "github.com/oracle/provider-oci/apis/namespaced/managedkafka/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(managedkafkaCluster.AddToScheme(mgr.GetScheme()), "Cannot add managedkafka Cluster APIs to scheme")
	kingpin.FatalIfError(managedkafkaNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add managedkafka Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_managedkafka(mgr, ClusterOpts), "Cannot setup managedkafka Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_managedkafka(mgr, NamespacedOpts), "Cannot setup managedkafka Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_managedkafka(mgr, ClusterOpts), "Cannot setup managedkafka Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_managedkafka(mgr, NamespacedOpts), "Cannot setup managedkafka Template controllers")
	}
