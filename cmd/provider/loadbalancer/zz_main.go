...
import (
	...
	loadbalancerCluster "github.com/oracle/provider-oci/apis/cluster/loadbalancer/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	loadbalancerNamespaced "github.com/oracle/provider-oci/apis/namespaced/loadbalancer/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(loadbalancerCluster.AddToScheme(mgr.GetScheme()), "Cannot add loadbalancer Cluster APIs to scheme")
	kingpin.FatalIfError(loadbalancerNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add loadbalancer Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_loadbalancer(mgr, ClusterOpts), "Cannot setup loadbalancer Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_loadbalancer(mgr, NamespacedOpts), "Cannot setup loadbalancer Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_loadbalancer(mgr, ClusterOpts), "Cannot setup loadbalancer Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_loadbalancer(mgr, NamespacedOpts), "Cannot setup loadbalancer Template controllers")
	}
