...
import (
	...
	networkingCluster "github.com/oracle/provider-oci/apis/cluster/networking/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	networkingNamespaced "github.com/oracle/provider-oci/apis/namespaced/networking/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(networkingCluster.AddToScheme(mgr.GetScheme()), "Cannot add networking Cluster APIs to scheme")
	kingpin.FatalIfError(networkingNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add networking Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_networking(mgr, ClusterOpts), "Cannot setup networking Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_networking(mgr, NamespacedOpts), "Cannot setup networking Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_networking(mgr, ClusterOpts), "Cannot setup networking Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_networking(mgr, NamespacedOpts), "Cannot setup networking Template controllers")
	}
