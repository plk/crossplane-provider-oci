...
import (
	...
	licensemanagerCluster "github.com/oracle/provider-oci/apis/cluster/licensemanager/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	licensemanagerNamespaced "github.com/oracle/provider-oci/apis/namespaced/licensemanager/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(licensemanagerCluster.AddToScheme(mgr.GetScheme()), "Cannot add licensemanager Cluster APIs to scheme")
	kingpin.FatalIfError(licensemanagerNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add licensemanager Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_licensemanager(mgr, ClusterOpts), "Cannot setup licensemanager Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_licensemanager(mgr, NamespacedOpts), "Cannot setup licensemanager Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_licensemanager(mgr, ClusterOpts), "Cannot setup licensemanager Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_licensemanager(mgr, NamespacedOpts), "Cannot setup licensemanager Template controllers")
	}
