...
import (
	...
	jmsCluster "github.com/oracle/provider-oci/apis/cluster/jms/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	jmsNamespaced "github.com/oracle/provider-oci/apis/namespaced/jms/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(jmsCluster.AddToScheme(mgr.GetScheme()), "Cannot add jms Cluster APIs to scheme")
	kingpin.FatalIfError(jmsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add jms Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_jms(mgr, ClusterOpts), "Cannot setup jms Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_jms(mgr, NamespacedOpts), "Cannot setup jms Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_jms(mgr, ClusterOpts), "Cannot setup jms Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_jms(mgr, NamespacedOpts), "Cannot setup jms Template controllers")
	}
