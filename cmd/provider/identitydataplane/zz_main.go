...
import (
	...
	identitydataplaneCluster "github.com/oracle/provider-oci/apis/cluster/identitydataplane/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	identitydataplaneNamespaced "github.com/oracle/provider-oci/apis/namespaced/identitydataplane/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(identitydataplaneCluster.AddToScheme(mgr.GetScheme()), "Cannot add identitydataplane Cluster APIs to scheme")
	kingpin.FatalIfError(identitydataplaneNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add identitydataplane Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_identitydataplane(mgr, ClusterOpts), "Cannot setup identitydataplane Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_identitydataplane(mgr, NamespacedOpts), "Cannot setup identitydataplane Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_identitydataplane(mgr, ClusterOpts), "Cannot setup identitydataplane Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_identitydataplane(mgr, NamespacedOpts), "Cannot setup identitydataplane Template controllers")
	}
