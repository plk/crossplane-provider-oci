...
import (
	...
	apmconfigCluster "github.com/oracle/provider-oci/apis/cluster/apmconfig/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	apmconfigNamespaced "github.com/oracle/provider-oci/apis/namespaced/apmconfig/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(apmconfigCluster.AddToScheme(mgr.GetScheme()), "Cannot add apmconfig Cluster APIs to scheme")
	kingpin.FatalIfError(apmconfigNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add apmconfig Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_apmconfig(mgr, ClusterOpts), "Cannot setup apmconfig Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_apmconfig(mgr, NamespacedOpts), "Cannot setup apmconfig Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_apmconfig(mgr, ClusterOpts), "Cannot setup apmconfig Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_apmconfig(mgr, NamespacedOpts), "Cannot setup apmconfig Template controllers")
	}
