...
import (
	...
	networkconnectivityCluster "github.com/oracle/provider-oci/apis/cluster/networkconnectivity/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	networkconnectivityNamespaced "github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(networkconnectivityCluster.AddToScheme(mgr.GetScheme()), "Cannot add networkconnectivity Cluster APIs to scheme")
	kingpin.FatalIfError(networkconnectivityNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add networkconnectivity Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_networkconnectivity(mgr, ClusterOpts), "Cannot setup networkconnectivity Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_networkconnectivity(mgr, NamespacedOpts), "Cannot setup networkconnectivity Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_networkconnectivity(mgr, ClusterOpts), "Cannot setup networkconnectivity Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_networkconnectivity(mgr, NamespacedOpts), "Cannot setup networkconnectivity Template controllers")
	}
