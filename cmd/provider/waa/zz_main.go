...
import (
	...
	waaCluster "github.com/oracle/provider-oci/apis/cluster/waa/v1alpha1"
	namespacedv1beta1 "github.com/oracle/provider-oci/apis/namespaced/v1beta1"
	waaNamespaced "github.com/oracle/provider-oci/apis/namespaced/waa/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(waaCluster.AddToScheme(mgr.GetScheme()), "Cannot add waa Cluster APIs to scheme")
	kingpin.FatalIfError(waaNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add waa Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_waa(mgr, ClusterOpts), "Cannot setup waa Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_waa(mgr, NamespacedOpts), "Cannot setup waa Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_waa(mgr, ClusterOpts), "Cannot setup waa Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_waa(mgr, NamespacedOpts), "Cannot setup waa Template controllers")
	}
