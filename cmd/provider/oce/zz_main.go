...
import (
	...
	oceCluster "github.com/oracle/provider-oci/apis/cluster/oce/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	oceNamespaced "github.com/oracle/provider-oci/apis/namespaced/oce/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(oceCluster.AddToScheme(mgr.GetScheme()), "Cannot add oce Cluster APIs to scheme")
	kingpin.FatalIfError(oceNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add oce Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_oce(mgr, ClusterOpts), "Cannot setup oce Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_oce(mgr, NamespacedOpts), "Cannot setup oce Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_oce(mgr, ClusterOpts), "Cannot setup oce Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_oce(mgr, NamespacedOpts), "Cannot setup oce Template controllers")
	}
