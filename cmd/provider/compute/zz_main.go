...
import (
	...
	computeCluster "github.com/oracle/provider-oci/apis/cluster/compute/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	computeNamespaced "github.com/oracle/provider-oci/apis/namespaced/compute/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(computeCluster.AddToScheme(mgr.GetScheme()), "Cannot add compute Cluster APIs to scheme")
	kingpin.FatalIfError(computeNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add compute Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_compute(mgr, ClusterOpts), "Cannot setup compute Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_compute(mgr, NamespacedOpts), "Cannot setup compute Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_compute(mgr, ClusterOpts), "Cannot setup compute Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_compute(mgr, NamespacedOpts), "Cannot setup compute Template controllers")
	}
