...
import (
	...
	goldengateCluster "github.com/oracle/provider-oci/apis/cluster/goldengate/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	goldengateNamespaced "github.com/oracle/provider-oci/apis/namespaced/goldengate/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(goldengateCluster.AddToScheme(mgr.GetScheme()), "Cannot add goldengate Cluster APIs to scheme")
	kingpin.FatalIfError(goldengateNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add goldengate Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_goldengate(mgr, ClusterOpts), "Cannot setup goldengate Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_goldengate(mgr, NamespacedOpts), "Cannot setup goldengate Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_goldengate(mgr, ClusterOpts), "Cannot setup goldengate Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_goldengate(mgr, NamespacedOpts), "Cannot setup goldengate Template controllers")
	}
