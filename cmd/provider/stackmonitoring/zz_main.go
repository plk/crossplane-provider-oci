...
import (
	...
	stackmonitoringCluster "github.com/oracle/provider-oci/apis/cluster/stackmonitoring/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	stackmonitoringNamespaced "github.com/oracle/provider-oci/apis/namespaced/stackmonitoring/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(stackmonitoringCluster.AddToScheme(mgr.GetScheme()), "Cannot add stackmonitoring Cluster APIs to scheme")
	kingpin.FatalIfError(stackmonitoringNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add stackmonitoring Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_stackmonitoring(mgr, ClusterOpts), "Cannot setup stackmonitoring Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_stackmonitoring(mgr, NamespacedOpts), "Cannot setup stackmonitoring Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_stackmonitoring(mgr, ClusterOpts), "Cannot setup stackmonitoring Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_stackmonitoring(mgr, NamespacedOpts), "Cannot setup stackmonitoring Template controllers")
	}
