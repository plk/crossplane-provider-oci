...
import (
	...
	eventsCluster "github.com/oracle/provider-oci/apis/cluster/events/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	eventsNamespaced "github.com/oracle/provider-oci/apis/namespaced/events/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(eventsCluster.AddToScheme(mgr.GetScheme()), "Cannot add events Cluster APIs to scheme")
	kingpin.FatalIfError(eventsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add events Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_events(mgr, ClusterOpts), "Cannot setup events Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_events(mgr, NamespacedOpts), "Cannot setup events Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_events(mgr, ClusterOpts), "Cannot setup events Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_events(mgr, NamespacedOpts), "Cannot setup events Template controllers")
	}
