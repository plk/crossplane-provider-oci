...
import (
	...
	fleetsoftwareupdateCluster "github.com/oracle/provider-oci/apis/cluster/fleetsoftwareupdate/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	fleetsoftwareupdateNamespaced "github.com/oracle/provider-oci/apis/namespaced/fleetsoftwareupdate/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(fleetsoftwareupdateCluster.AddToScheme(mgr.GetScheme()), "Cannot add fleetsoftwareupdate Cluster APIs to scheme")
	kingpin.FatalIfError(fleetsoftwareupdateNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add fleetsoftwareupdate Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_fleetsoftwareupdate(mgr, ClusterOpts), "Cannot setup fleetsoftwareupdate Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_fleetsoftwareupdate(mgr, NamespacedOpts), "Cannot setup fleetsoftwareupdate Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_fleetsoftwareupdate(mgr, ClusterOpts), "Cannot setup fleetsoftwareupdate Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_fleetsoftwareupdate(mgr, NamespacedOpts), "Cannot setup fleetsoftwareupdate Template controllers")
	}
