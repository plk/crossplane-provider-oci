...
import (
	...
	limitsCluster "github.com/oracle/provider-oci/apis/cluster/limits/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	limitsNamespaced "github.com/oracle/provider-oci/apis/namespaced/limits/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(limitsCluster.AddToScheme(mgr.GetScheme()), "Cannot add limits Cluster APIs to scheme")
	kingpin.FatalIfError(limitsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add limits Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_limits(mgr, ClusterOpts), "Cannot setup limits Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_limits(mgr, NamespacedOpts), "Cannot setup limits Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_limits(mgr, ClusterOpts), "Cannot setup limits Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_limits(mgr, NamespacedOpts), "Cannot setup limits Template controllers")
	}
