...
import (
	...
	opensearchCluster "github.com/oracle/provider-oci/apis/cluster/opensearch/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	opensearchNamespaced "github.com/oracle/provider-oci/apis/namespaced/opensearch/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(opensearchCluster.AddToScheme(mgr.GetScheme()), "Cannot add opensearch Cluster APIs to scheme")
	kingpin.FatalIfError(opensearchNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add opensearch Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_opensearch(mgr, ClusterOpts), "Cannot setup opensearch Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_opensearch(mgr, NamespacedOpts), "Cannot setup opensearch Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_opensearch(mgr, ClusterOpts), "Cannot setup opensearch Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_opensearch(mgr, NamespacedOpts), "Cannot setup opensearch Template controllers")
	}
