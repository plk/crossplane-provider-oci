...
import (
	...
	analyticsCluster "github.com/oracle/provider-oci/apis/cluster/analytics/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	analyticsNamespaced "github.com/oracle/provider-oci/apis/namespaced/analytics/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(analyticsCluster.AddToScheme(mgr.GetScheme()), "Cannot add analytics Cluster APIs to scheme")
	kingpin.FatalIfError(analyticsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add analytics Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_analytics(mgr, ClusterOpts), "Cannot setup analytics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_analytics(mgr, NamespacedOpts), "Cannot setup analytics Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_analytics(mgr, ClusterOpts), "Cannot setup analytics Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_analytics(mgr, NamespacedOpts), "Cannot setup analytics Template controllers")
	}
