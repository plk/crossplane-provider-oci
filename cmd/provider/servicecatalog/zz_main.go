...
func main() {
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_servicecatalog(mgr, ClusterOpts), "Cannot setup servicecatalog Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_servicecatalog(mgr, NamespacedOpts), "Cannot setup servicecatalog Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_servicecatalog(mgr, ClusterOpts), "Cannot setup servicecatalog Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_servicecatalog(mgr, NamespacedOpts), "Cannot setup servicecatalog Template controllers")
	}
