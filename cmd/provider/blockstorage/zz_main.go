...
import (
	...
	blockstorageCluster "github.com/oracle/provider-oci/apis/cluster/blockstorage/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	blockstorageNamespaced "github.com/oracle/provider-oci/apis/namespaced/blockstorage/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(blockstorageCluster.AddToScheme(mgr.GetScheme()), "Cannot add blockstorage Cluster APIs to scheme")
	kingpin.FatalIfError(blockstorageNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add blockstorage Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_blockstorage(mgr, ClusterOpts), "Cannot setup blockstorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_blockstorage(mgr, NamespacedOpts), "Cannot setup blockstorage Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_blockstorage(mgr, ClusterOpts), "Cannot setup blockstorage Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_blockstorage(mgr, NamespacedOpts), "Cannot setup blockstorage Template controllers")
	}
