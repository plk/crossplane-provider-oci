...
import (
	...
	containerinstancesCluster "github.com/oracle/provider-oci/apis/cluster/containerinstances/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	containerinstancesNamespaced "github.com/oracle/provider-oci/apis/namespaced/containerinstances/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(containerinstancesCluster.AddToScheme(mgr.GetScheme()), "Cannot add containerinstances Cluster APIs to scheme")
	kingpin.FatalIfError(containerinstancesNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add containerinstances Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_containerinstances(mgr, ClusterOpts), "Cannot setup containerinstances Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_containerinstances(mgr, NamespacedOpts), "Cannot setup containerinstances Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_containerinstances(mgr, ClusterOpts), "Cannot setup containerinstances Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_containerinstances(mgr, NamespacedOpts), "Cannot setup containerinstances Template controllers")
	}
