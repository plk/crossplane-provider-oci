...
import (
	...
	datacatalogCluster "github.com/oracle/provider-oci/apis/cluster/datacatalog/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	datacatalogNamespaced "github.com/oracle/provider-oci/apis/namespaced/datacatalog/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(datacatalogCluster.AddToScheme(mgr.GetScheme()), "Cannot add datacatalog Cluster APIs to scheme")
	kingpin.FatalIfError(datacatalogNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add datacatalog Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_datacatalog(mgr, ClusterOpts), "Cannot setup datacatalog Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_datacatalog(mgr, NamespacedOpts), "Cannot setup datacatalog Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_datacatalog(mgr, ClusterOpts), "Cannot setup datacatalog Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_datacatalog(mgr, NamespacedOpts), "Cannot setup datacatalog Template controllers")
	}
