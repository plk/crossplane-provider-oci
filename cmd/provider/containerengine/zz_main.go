...
import (
	...
	containerengineCluster "github.com/oracle/provider-oci/apis/cluster/containerengine/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	containerengineNamespaced "github.com/oracle/provider-oci/apis/namespaced/containerengine/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(containerengineCluster.AddToScheme(mgr.GetScheme()), "Cannot add containerengine Cluster APIs to scheme")
	kingpin.FatalIfError(containerengineNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add containerengine Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_containerengine(mgr, ClusterOpts), "Cannot setup containerengine Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_containerengine(mgr, NamespacedOpts), "Cannot setup containerengine Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_containerengine(mgr, ClusterOpts), "Cannot setup containerengine Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_containerengine(mgr, NamespacedOpts), "Cannot setup containerengine Template controllers")
	}
