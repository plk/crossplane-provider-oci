...
import (
	...
	optimizerCluster "github.com/oracle/provider-oci/apis/cluster/optimizer/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	optimizerNamespaced "github.com/oracle/provider-oci/apis/namespaced/optimizer/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(optimizerCluster.AddToScheme(mgr.GetScheme()), "Cannot add optimizer Cluster APIs to scheme")
	kingpin.FatalIfError(optimizerNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add optimizer Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_optimizer(mgr, ClusterOpts), "Cannot setup optimizer Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_optimizer(mgr, NamespacedOpts), "Cannot setup optimizer Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_optimizer(mgr, ClusterOpts), "Cannot setup optimizer Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_optimizer(mgr, NamespacedOpts), "Cannot setup optimizer Template controllers")
	}
