...
import (
	...
	managementdashboardCluster "github.com/oracle/provider-oci/apis/cluster/managementdashboard/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	managementdashboardNamespaced "github.com/oracle/provider-oci/apis/namespaced/managementdashboard/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(managementdashboardCluster.AddToScheme(mgr.GetScheme()), "Cannot add managementdashboard Cluster APIs to scheme")
	kingpin.FatalIfError(managementdashboardNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add managementdashboard Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_managementdashboard(mgr, ClusterOpts), "Cannot setup managementdashboard Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_managementdashboard(mgr, NamespacedOpts), "Cannot setup managementdashboard Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_managementdashboard(mgr, ClusterOpts), "Cannot setup managementdashboard Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_managementdashboard(mgr, NamespacedOpts), "Cannot setup managementdashboard Template controllers")
	}
