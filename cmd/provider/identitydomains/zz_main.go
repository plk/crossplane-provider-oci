...
import (
	...
	identitydomainsCluster "github.com/oracle/provider-oci/apis/cluster/identitydomains/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	identitydomainsNamespaced "github.com/oracle/provider-oci/apis/namespaced/identitydomains/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(identitydomainsCluster.AddToScheme(mgr.GetScheme()), "Cannot add identitydomains Cluster APIs to scheme")
	kingpin.FatalIfError(identitydomainsNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add identitydomains Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_identitydomains(mgr, ClusterOpts), "Cannot setup identitydomains Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_identitydomains(mgr, NamespacedOpts), "Cannot setup identitydomains Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_identitydomains(mgr, ClusterOpts), "Cannot setup identitydomains Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_identitydomains(mgr, NamespacedOpts), "Cannot setup identitydomains Template controllers")
	}
