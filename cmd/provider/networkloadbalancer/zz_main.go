...
import (
	...
	networkloadbalancerCluster "github.com/oracle/provider-oci/apis/cluster/networkloadbalancer/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	networkloadbalancerNamespaced "github.com/oracle/provider-oci/apis/namespaced/networkloadbalancer/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(networkloadbalancerCluster.AddToScheme(mgr.GetScheme()), "Cannot add networkloadbalancer Cluster APIs to scheme")
	kingpin.FatalIfError(networkloadbalancerNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add networkloadbalancer Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_networkloadbalancer(mgr, ClusterOpts), "Cannot setup networkloadbalancer Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_networkloadbalancer(mgr, NamespacedOpts), "Cannot setup networkloadbalancer Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_networkloadbalancer(mgr, ClusterOpts), "Cannot setup networkloadbalancer Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_networkloadbalancer(mgr, NamespacedOpts), "Cannot setup networkloadbalancer Template controllers")
	}
