...
import (
	...
	psqlCluster "github.com/oracle/provider-oci/apis/cluster/psql/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	psqlNamespaced "github.com/oracle/provider-oci/apis/namespaced/psql/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(psqlCluster.AddToScheme(mgr.GetScheme()), "Cannot add psql Cluster APIs to scheme")
	kingpin.FatalIfError(psqlNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add psql Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_psql(mgr, ClusterOpts), "Cannot setup psql Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_psql(mgr, NamespacedOpts), "Cannot setup psql Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_psql(mgr, ClusterOpts), "Cannot setup psql Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_psql(mgr, NamespacedOpts), "Cannot setup psql Template controllers")
	}
