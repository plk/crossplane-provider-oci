...
import (
	...
	securityattributeCluster "github.com/oracle/provider-oci/apis/cluster/securityattribute/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	securityattributeNamespaced "github.com/oracle/provider-oci/apis/namespaced/securityattribute/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(securityattributeCluster.AddToScheme(mgr.GetScheme()), "Cannot add securityattribute Cluster APIs to scheme")
	kingpin.FatalIfError(securityattributeNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add securityattribute Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_securityattribute(mgr, ClusterOpts), "Cannot setup securityattribute Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_securityattribute(mgr, NamespacedOpts), "Cannot setup securityattribute Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_securityattribute(mgr, ClusterOpts), "Cannot setup securityattribute Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_securityattribute(mgr, NamespacedOpts), "Cannot setup securityattribute Template controllers")
	}
