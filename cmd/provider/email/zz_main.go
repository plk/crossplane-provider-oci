...
import (
	...
	emailCluster "github.com/oracle/provider-oci/apis/cluster/email/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	emailNamespaced "github.com/oracle/provider-oci/apis/namespaced/email/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(emailCluster.AddToScheme(mgr.GetScheme()), "Cannot add email Cluster APIs to scheme")
	kingpin.FatalIfError(emailNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add email Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_email(mgr, ClusterOpts), "Cannot setup email Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_email(mgr, NamespacedOpts), "Cannot setup email Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_email(mgr, ClusterOpts), "Cannot setup email Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_email(mgr, NamespacedOpts), "Cannot setup email Template controllers")
	}
