...
import (
	...
	resourcemanagerCluster "github.com/oracle/provider-oci/apis/cluster/resourcemanager/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	resourcemanagerNamespaced "github.com/oracle/provider-oci/apis/namespaced/resourcemanager/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(resourcemanagerCluster.AddToScheme(mgr.GetScheme()), "Cannot add resourcemanager Cluster APIs to scheme")
	kingpin.FatalIfError(resourcemanagerNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add resourcemanager Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_resourcemanager(mgr, ClusterOpts), "Cannot setup resourcemanager Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_resourcemanager(mgr, NamespacedOpts), "Cannot setup resourcemanager Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_resourcemanager(mgr, ClusterOpts), "Cannot setup resourcemanager Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_resourcemanager(mgr, NamespacedOpts), "Cannot setup resourcemanager Template controllers")
	}
