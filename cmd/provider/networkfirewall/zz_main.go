...
import (
	...
	networkfirewallCluster "github.com/oracle/provider-oci/apis/cluster/networkfirewall/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	networkfirewallNamespaced "github.com/oracle/provider-oci/apis/namespaced/networkfirewall/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(networkfirewallCluster.AddToScheme(mgr.GetScheme()), "Cannot add networkfirewall Cluster APIs to scheme")
	kingpin.FatalIfError(networkfirewallNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add networkfirewall Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_networkfirewall(mgr, ClusterOpts), "Cannot setup networkfirewall Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_networkfirewall(mgr, NamespacedOpts), "Cannot setup networkfirewall Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_networkfirewall(mgr, ClusterOpts), "Cannot setup networkfirewall Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_networkfirewall(mgr, NamespacedOpts), "Cannot setup networkfirewall Template controllers")
	}
