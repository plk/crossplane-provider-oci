...
import (
	...
	announcementsserviceCluster "github.com/oracle/provider-oci/apis/cluster/announcementsservice/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	announcementsserviceNamespaced "github.com/oracle/provider-oci/apis/namespaced/announcementsservice/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(announcementsserviceCluster.AddToScheme(mgr.GetScheme()), "Cannot add announcementsservice Cluster APIs to scheme")
	kingpin.FatalIfError(announcementsserviceNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add announcementsservice Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_announcementsservice(mgr, ClusterOpts), "Cannot setup announcementsservice Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_announcementsservice(mgr, NamespacedOpts), "Cannot setup announcementsservice Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_announcementsservice(mgr, ClusterOpts), "Cannot setup announcementsservice Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_announcementsservice(mgr, NamespacedOpts), "Cannot setup announcementsservice Template controllers")
	}
