...
import (
	...
	mysqlCluster "github.com/oracle/provider-oci/apis/cluster/mysql/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	mysqlNamespaced "github.com/oracle/provider-oci/apis/namespaced/mysql/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(mysqlCluster.AddToScheme(mgr.GetScheme()), "Cannot add mysql Cluster APIs to scheme")
	kingpin.FatalIfError(mysqlNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add mysql Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_mysql(mgr, ClusterOpts), "Cannot setup mysql Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_mysql(mgr, NamespacedOpts), "Cannot setup mysql Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_mysql(mgr, ClusterOpts), "Cannot setup mysql Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_mysql(mgr, NamespacedOpts), "Cannot setup mysql Template controllers")
	}
