...
import (
	...
	queueCluster "github.com/oracle/provider-oci/apis/cluster/queue/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	queueNamespaced "github.com/oracle/provider-oci/apis/namespaced/queue/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(queueCluster.AddToScheme(mgr.GetScheme()), "Cannot add queue Cluster APIs to scheme")
	kingpin.FatalIfError(queueNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add queue Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_queue(mgr, ClusterOpts), "Cannot setup queue Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_queue(mgr, NamespacedOpts), "Cannot setup queue Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_queue(mgr, ClusterOpts), "Cannot setup queue Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_queue(mgr, NamespacedOpts), "Cannot setup queue Template controllers")
	}
