...
import (
	...
	odaCluster "github.com/oracle/provider-oci/apis/cluster/oda/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	odaNamespaced "github.com/oracle/provider-oci/apis/namespaced/oda/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(odaCluster.AddToScheme(mgr.GetScheme()), "Cannot add oda Cluster APIs to scheme")
	kingpin.FatalIfError(odaNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add oda Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_oda(mgr, ClusterOpts), "Cannot setup oda Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_oda(mgr, NamespacedOpts), "Cannot setup oda Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_oda(mgr, ClusterOpts), "Cannot setup oda Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_oda(mgr, NamespacedOpts), "Cannot setup oda Template controllers")
	}
