...
import (
	...
	marketplaceCluster "github.com/oracle/provider-oci/apis/cluster/marketplace/v1alpha1"
	clusterv1beta1 "github.com/oracle/provider-oci/apis/cluster/v1beta1"
	marketplaceNamespaced "github.com/oracle/provider-oci/apis/namespaced/marketplace/v1alpha1"
...
func main() {
	...
	kingpin.FatalIfError(marketplaceCluster.AddToScheme(mgr.GetScheme()), "Cannot add marketplace Cluster APIs to scheme")
	kingpin.FatalIfError(marketplaceNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add marketplace Namespaced APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_marketplace(mgr, ClusterOpts), "Cannot setup marketplace Template controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_marketplace(mgr, NamespacedOpts), "Cannot setup marketplace Template controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_marketplace(mgr, ClusterOpts), "Cannot setup marketplace Template controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_marketplace(mgr, NamespacedOpts), "Cannot setup marketplace Template controllers")
	}
