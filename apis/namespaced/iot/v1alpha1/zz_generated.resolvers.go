...
// ResolveReferences of this DigitalTwinAdapter.
func (mg *DigitalTwinAdapter) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &DigitalTwinModelList{},
			Managed: &DigitalTwinModel{},
		},
	})
	if err != nil {
...
func (mg *DigitalTwinInstance) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &DigitalTwinAdapterList{},
			Managed: &DigitalTwinAdapter{},
		},
	})
	if err != nil {
...
func (mg *DigitalTwinInstanceInvokeRawCommand) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &DigitalTwinInstanceList{},
			Managed: &DigitalTwinInstance{},
		},
	})
	if err != nil {
...
func (mg *IotDomain) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &IotDomainGroupList{},
			Managed: &IotDomainGroup{},
		},
	})
	if err != nil {
