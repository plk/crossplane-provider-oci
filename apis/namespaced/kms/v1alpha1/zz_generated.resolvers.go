...
// ResolveReferences of this EkmsPrivateEndpoint.
func (mg *EkmsPrivateEndpoint) ResolveReferences(ctx context.Context, c client.Reader) error {
...
func (mg *Vault) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.ExternalKeyManagerMetadata); i3++ {
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			...
			To: reference.To{
				List:    &v1alpha12.PrivateEndpointList{},
				Managed: &v1alpha12.PrivateEndpoint{},
			},
		})
		if err != nil {
