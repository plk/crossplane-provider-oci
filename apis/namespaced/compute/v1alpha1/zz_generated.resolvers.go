...
import (
	...
	v1alpha14 "github.com/oracle/provider-oci/apis/namespaced/loadbalancer/v1alpha1"
	v1alpha11 "github.com/oracle/provider-oci/apis/namespaced/networking/v1alpha1"
	errors "github.com/pkg/errors"
	client "sigs.k8s.io/controller-runtime/pkg/client"
)

// ResolveReferences of this AppCatalogSubscription.
func (mg *AppCatalogSubscription) ResolveReferences(ctx context.Context, c client.Reader) error {
...
func (mg *ClusterNetwork) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.InstancePools); i3++ {
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			...
			To: reference.To{
				List:    &InstanceConfigurationList{},
				Managed: &InstanceConfiguration{},
			},
		})
		if err != nil {
...
func (mg *ComputeGpuMemoryCluster) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &ComputeClusterList{},
			Managed: &ComputeCluster{},
		},
	})
	if err != nil {
...
func (mg *ComputeGpuMemoryFabric) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &ComputeGpuMemoryFabricList{},
			Managed: &ComputeGpuMemoryFabric{},
		},
	})
	if err != nil {
...
func (mg *Instance) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.CreateVnicDetails); i3++ {
		for i4 := 0; i4 < len(mg.Spec.ForProvider.CreateVnicDetails[i3].Ipv6AddressIpv6SubnetCidrPairDetails); i4++ {
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
				...
				To: reference.To{
					List:    &v1alpha11.Ipv6List{},
					Managed: &v1alpha11.Ipv6{},
				},
			})
			if err != nil {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.CreateVnicDetails); i3++ {
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			...
			To: reference.To{
				List:    &v1alpha11.PrivateIpList{},
				Managed: &v1alpha11.PrivateIp{},
			},
		})
		if err != nil {
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.InstanceDetails[i3].LaunchDetails); i4++ {
			for i5 := 0; i5 < len(mg.Spec.ForProvider.InstanceDetails[i3].LaunchDetails[i4].PlacementConstraintDetails); i5++ {
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					...
					To: reference.To{
						List:    &ComputeHostGroupList{},
						Managed: &ComputeHostGroup{},
					},
				})
				if err != nil {
		...
		for i4 := 0; i4 < len(mg.Spec.ForProvider.InstanceDetails[i3].LaunchDetails); i4++ {
			for i5 := 0; i5 < len(mg.Spec.ForProvider.InstanceDetails[i3].LaunchDetails[i4].SourceDetails); i5++ {
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					...
					To: reference.To{
						List:    &v1alpha13.BootVolumeList{},
						Managed: &v1alpha13.BootVolume{},
					},
				})
				if err != nil {
...
func (mg *InstanceMaintenanceEvent) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &InstanceMaintenanceEventList{},
			Managed: &InstanceMaintenanceEvent{},
		},
	})
	if err != nil {
...
func (mg *InstancePool) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.LoadBalancers); i3++ {
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			...
			To: reference.To{
				List:    &v1alpha14.BackendSetList{},
				Managed: &v1alpha14.BackendSet{},
			},
		})
		if err != nil {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.LoadBalancers); i3++ {
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			...
			To: reference.To{
				List:    &v1alpha14.LoadBalancerList{},
				Managed: &v1alpha14.LoadBalancer{},
			},
		})
		if err != nil {
