...
import (
	...
	v1alpha11 "github.com/oracle/provider-oci/apis/namespaced/networkconnectivity/v1alpha1"
	errors "github.com/pkg/errors"
	client "sigs.k8s.io/controller-runtime/pkg/client"
)

// ResolveReferences of this DefaultDhcpOptions.
func (mg *DefaultDhcpOptions) ResolveReferences(ctx context.Context, c client.Reader) error {
...
func (mg *LocalPeeringGateway) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &LocalPeeringGatewayList{},
			Managed: &LocalPeeringGateway{},
		},
	})
	if err != nil {
...
func (mg *RemotePeeringConnection) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha11.DrgList{},
			Managed: &v1alpha11.Drg{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		Selector:     mg.Spec.ForProvider.PeerIDSelector,
		To: reference.To{
			List:    &RemotePeeringConnectionList{},
			Managed: &RemotePeeringConnection{},
		},
	})
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.PeerID")
