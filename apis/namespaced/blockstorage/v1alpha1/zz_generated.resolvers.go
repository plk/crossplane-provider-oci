...
// ResolveReferences of this BootVolume.
func (mg *BootVolume) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.SourceDetails); i3++ {
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			...
			To: reference.To{
				List:    &v1alpha12.BackupList{},
				Managed: &v1alpha12.Backup{},
			},
		})
		if err != nil {
...
func (mg *VolumeAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha13.InstanceList{},
			Managed: &v1alpha13.Instance{},
		},
	})
	if err != nil {
