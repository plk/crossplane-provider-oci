...
import (
	...
	v1alpha11 "github.com/oracle/provider-oci/apis/namespaced/mysql/v1alpha1"
	errors "github.com/pkg/errors"
	client "sigs.k8s.io/controller-runtime/pkg/client"
)

// ResolveReferences of this MediaAsset.
func (mg *MediaAsset) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &MediaWorkflowJobList{},
			Managed: &MediaWorkflowJob{},
		},
	})
	if err != nil {
...
func (mg *StreamCdnConfig) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha11.MysqlChannelList{},
			Managed: &v1alpha11.MysqlChannel{},
		},
	})
	if err != nil {
